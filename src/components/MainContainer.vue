  ...
  <div class="main-container">
    ...
    <div class="instruction">
      <p class="about-game">
        ...
        <a
          class="yrp"
          href="https://itunes.apple.com/us/app/2048-by-gabriele-cirulli/id868076805"
          target="_blank"
          >iOS</a
        >
        'and'
        <a
          class="yrp"
          href="https://play.google.com/store/apps/details?id=com.gabrielecirulli.app2048"
          target="_blank"
          >Android!</a
        >
      ...
      <p>
        Created by
        <a class="yrp" href="http://gabrielecirulli.com" target="_blank"
          >Gabriele Cirulli.</a
        >
        Based on
        <a
